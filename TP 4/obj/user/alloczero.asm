...
write_page(uint16_t *addr, uint16_t value)
{
  ...
  800071:	c3                   	ret    
		panic("sys_page_alloc: %e", r);
  800072:	50                   	push   %eax
  800073:	68 c0 1e 80 00       	push   $0x801ec0
  800078:	6a 0b                	push   $0xb
  80007a:	68 d3 1e 80 00       	push   $0x801ed3
  80007f:	e8 28 01 00 00       	call   8001ac <_panic>
		panic("sys_page_unmap: %e", r);
  800084:	50                   	push   %eax
  800085:	68 e4 1e 80 00       	push   $0x801ee4
  80008a:	6a 0e                	push   $0xe
  80008c:	68 d3 1e 80 00       	push   $0x801ed3
...
umain(int argc, char **argv)
{
  ...
  80012f:	c7 04 24 28 1f 80 00 	movl   $0x801f28,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001cc:	56                   	push   %esi
  8001cd:	50                   	push   %eax
  8001ce:	68 60 1f 80 00       	push   $0x801f60
  ...
  8001df:	e8 5a 00 00 00       	call   80023e <vcprintf>
	cprintf("\n");
  8001e4:	c7 04 24 83 23 80 00 	movl   $0x802383,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002f9:	e8 62 19 00 00       	call   801c60 <__udivdi3>
  ...
  800337:	e8 34 1a 00 00       	call   801d70 <__umoddi3>
  80033c:	83 c4 14             	add    $0x14,%esp
  80033f:	0f be 80 83 1f 80 00 	movsbl 0x801f83(%eax),%eax
  800346:	50                   	push   %eax
...
008003f6 <vprintfmt>:
{
  ...
  800446:	3e ff 24 85 c0 20 80 	notrack jmp *0x8020c0(,%eax,4)
  80044d:	00 
  ...
  800513:	8b 14 85 20 22 80 00 	mov    0x802220(,%eax,4),%edx
  80051a:	85 d2                	test   %edx,%edx
  80051c:	74 15                	je     800533 <vprintfmt+0x13d>
				printfmt(putch, putdat, "%s", p);
  80051e:	52                   	push   %edx
  80051f:	68 51 23 80 00       	push   $0x802351
  800524:	56                   	push   %esi
  800525:	53                   	push   %ebx
  ...
  800533:	50                   	push   %eax
  800534:	68 9b 1f 80 00       	push   $0x801f9b
  800539:	56                   	push   %esi
  80053a:	53                   	push   %ebx
  ...
  800555:	b8 94 1f 80 00       	mov    $0x801f94,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ba9:	68 7f 22 80 00       	push   $0x80227f
  800bae:	6a 23                	push   $0x23
  800bb0:	68 9c 22 80 00       	push   $0x80229c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800eac:	ba 28 23 80 00       	mov    $0x802328,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800ece:	51                   	push   %ecx
  800ecf:	50                   	push   %eax
  800ed0:	68 ac 22 80 00       	push   $0x8022ac
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80113c:	53                   	push   %ebx
  80113d:	50                   	push   %eax
  80113e:	68 ed 22 80 00       	push   $0x8022ed
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80120d:	53                   	push   %ebx
  80120e:	50                   	push   %eax
  80120f:	68 09 23 80 00       	push   $0x802309
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012bd:	53                   	push   %ebx
  8012be:	50                   	push   %eax
  8012bf:	68 cc 22 80 00       	push   $0x8022cc
...
00801493 <devfile_write>:
{
  ...
  8014c7:	e8 e9 f4 ff ff       	call   8009b5 <memmove>
...
008014dd <devfile_read>:
{
  ...
  801526:	e8 8a f4 ff ff       	call   8009b5 <memmove>
	return r;
  ...
  801536:	c3                   	ret    
	assert(r <= n);
  801537:	68 38 23 80 00       	push   $0x802338
  80153c:	68 3f 23 80 00       	push   $0x80233f
  801541:	6a 7c                	push   $0x7c
  801543:	68 54 23 80 00       	push   $0x802354
  801548:	e8 5f ec ff ff       	call   8001ac <_panic>
	assert(r <= PGSIZE);
  80154d:	68 5f 23 80 00       	push   $0x80235f
  801552:	68 3f 23 80 00       	push   $0x80233f
  801557:	6a 7d                	push   $0x7d
  801559:	68 54 23 80 00       	push   $0x802354
  80155e:	e8 49 ec ff ff       	call   8001ac <_panic>
...
00801563 <open>:
{
  ...
  801572:	56                   	push   %esi
  801573:	e8 42 f2 ff ff       	call   8007ba <strlen>
  ...
  8015a0:	e8 58 f2 ff ff       	call   8007fd <strcpy>
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80162c:	68 6b 23 80 00       	push   $0x80236b
  801631:	53                   	push   %ebx
  801632:	e8 c6 f1 ff ff       	call   8007fd <strcpy>
...
devpipe_close(struct Fd *fd)
{
  ...
  801673:	e8 5f f6 ff ff       	call   800cd7 <sys_page_unmap>
  ...
  801686:	e8 4c f6 ff ff       	call   800cd7 <sys_page_unmap>
}
...
00801690 <_pipeisclosed>:
{
  ...
  8016d3:	50                   	push   %eax
  8016d4:	53                   	push   %ebx
  8016d5:	68 72 23 80 00       	push   $0x802372
  8016da:	e8 b4 eb ff ff       	call   800293 <cprintf>
...
008016f5 <devpipe_write>:
{
  ...
  801731:	75 3b                	jne    80176e <devpipe_write+0x79>
			sys_yield();
  801733:	e8 22 f5 ff ff       	call   800c5a <sys_yield>
...
0080177b <devpipe_read>:
{
  ...
  8017ae:	c3                   	ret    
			sys_yield();
  8017af:	e8 a6 f4 ff ff       	call   800c5a <sys_yield>
...
008017f1 <pipe>:
{
  ...
  801820:	e8 60 f4 ff ff       	call   800c85 <sys_page_alloc>
  ...
  801858:	e8 28 f4 ff ff       	call   800c85 <sys_page_alloc>
  ...
  801882:	e8 fe f3 ff ff       	call   800c85 <sys_page_alloc>
  ...
  8018ac:	e8 fc f3 ff ff       	call   800cad <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80198a:	68 8a 23 80 00       	push   $0x80238a
  80198f:	ff 75 0c             	pushl  0xc(%ebp)
  801992:	e8 66 ee ff ff       	call   8007fd <strcpy>
	return 0;
}
...
0080199e <devcons_write>:
{
  ...
  8019d7:	50                   	push   %eax
  8019d8:	57                   	push   %edi
  8019d9:	e8 d7 ef ff ff       	call   8009b5 <memmove>
		sys_cputs(buf, m);
  8019de:	83 c4 08             	add    $0x8,%esp
  8019e1:	53                   	push   %ebx
  8019e2:	57                   	push   %edi
  8019e3:	e8 d2 f1 ff ff       	call   800bba <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
...
008019f9 <devcons_read>:
{
  ...
  801a0c:	74 21                	je     801a2f <devcons_read+0x36>
	while ((c = sys_cgetc()) == 0)
  801a0e:	e8 d1 f1 ff ff       	call   800be4 <sys_cgetc>
  801a13:	85 c0                	test   %eax,%eax
  801a15:	75 07                	jne    801a1e <devcons_read+0x25>
		sys_yield();
  801a17:	e8 3e f2 ff ff       	call   800c5a <sys_yield>
...
00801a38 <cputchar>:
{
  ...
  801a4d:	50                   	push   %eax
  801a4e:	e8 67 f1 ff ff       	call   800bba <sys_cputs>
}
...
00801ab5 <opencons>:
{
  ...
  801adc:	e8 a4 f1 ff ff       	call   800c85 <sys_page_alloc>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b2a:	50                   	push   %eax
  801b2b:	e8 6c f2 ff ff       	call   800d9c <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b98:	56                   	push   %esi
  801b99:	57                   	push   %edi
  801b9a:	e8 d4 f1 ff ff       	call   800d73 <sys_ipc_try_send>
  ...
  801ba9:	75 19                	jne    801bc4 <ipc_send+0x4b>
		...
		sys_yield();
  801bab:	e8 aa f0 ff ff       	call   800c5a <sys_yield>
		if (pg != NULL) {
  ...
  801bb8:	56                   	push   %esi
  801bb9:	57                   	push   %edi
  801bba:	e8 b4 f1 ff ff       	call   800d73 <sys_ipc_try_send>
  801bbf:	83 c4 10             	add    $0x10,%esp
  801bc2:	eb de                	jmp    801ba2 <ipc_send+0x29>
			panic("ipc_send: %d", res);
  801bc4:	50                   	push   %eax
  801bc5:	68 96 23 80 00       	push   $0x802396
  801bca:	6a 3e                	push   $0x3e
  801bcc:	68 a3 23 80 00       	push   $0x8023a3
  801bd1:	e8 d6 e5 ff ff       	call   8001ac <_panic>
	}
}
