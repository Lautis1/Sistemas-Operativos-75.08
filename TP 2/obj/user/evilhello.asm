...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000f2:	68 ea 1d 80 00       	push   $0x801dea
  8000f7:	6a 23                	push   $0x23
  8000f9:	68 07 1e 80 00       	push   $0x801e07
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8003f5:	ba 94 1e 80 00       	mov    $0x801e94,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800417:	51                   	push   %ecx
  800418:	50                   	push   %eax
  800419:	68 18 1e 80 00       	push   $0x801e18
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800685:	53                   	push   %ebx
  800686:	50                   	push   %eax
  800687:	68 59 1e 80 00       	push   $0x801e59
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800806:	53                   	push   %ebx
  800807:	50                   	push   %eax
  800808:	68 38 1e 80 00       	push   $0x801e38
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b75:	68 d7 1e 80 00       	push   $0x801ed7
  800b7a:	53                   	push   %ebx
...
00800bd9 <_pipeisclosed>:
{
  ...
  800c1c:	50                   	push   %eax
  800c1d:	53                   	push   %ebx
  800c1e:	68 de 1e 80 00       	push   $0x801ede
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ed3:	68 f6 1e 80 00       	push   $0x801ef6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801074:	56                   	push   %esi
  801075:	50                   	push   %eax
  801076:	68 04 1f 80 00       	push   $0x801f04
  ...
  801087:	e8 5a 00 00 00       	call   8010e6 <vcprintf>
	cprintf("\n");
  80108c:	c7 04 24 ef 1e 80 00 	movl   $0x801eef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8011e7:	0f be 80 27 1f 80 00 	movsbl 0x801f27(%eax),%eax
  8011ee:	50                   	push   %eax
...
0080129e <vprintfmt>:
{
  ...
  8013c6:	52                   	push   %edx
  8013c7:	68 bd 1e 80 00       	push   $0x801ebd
  8013cc:	56                   	push   %esi
  8013cd:	53                   	push   %ebx
  ...
  8013db:	50                   	push   %eax
  8013dc:	68 3f 1f 80 00       	push   $0x801f3f
  8013e1:	56                   	push   %esi
  8013e2:	53                   	push   %ebx
  ...
  8013fd:	b8 38 1f 80 00       	mov    $0x801f38,%eax
