...
umain(int argc, char **argv)
{
  ...
  80003a:	83 ec 14             	sub    $0x14,%esp
	cprintf("hello, world\n");
  80003d:	68 e0 1d 80 00       	push   $0x801de0
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ce:	e8 ad 19 00 00       	call   801b80 <__udivdi3>
  ...
  80020c:	e8 7f 1a 00 00       	call   801c90 <__umoddi3>
  800211:	83 c4 14             	add    $0x14,%esp
  800214:	0f be 80 0f 1e 80 00 	movsbl 0x801e0f(%eax),%eax
  80021b:	50                   	push   %eax
...
008002cb <vprintfmt>:
{
  ...
  80031b:	3e ff 24 85 60 1f 80 	notrack jmp *0x801f60(,%eax,4)
  800322:	00 
  ...
  8003e8:	8b 14 85 c0 20 80 00 	mov    0x8020c0(,%eax,4),%edx
  8003ef:	85 d2                	test   %edx,%edx
  8003f1:	74 15                	je     800408 <vprintfmt+0x13d>
				printfmt(putch, putdat, "%s", p);
  8003f3:	52                   	push   %edx
  8003f4:	68 f1 21 80 00       	push   $0x8021f1
  8003f9:	56                   	push   %esi
  8003fa:	53                   	push   %ebx
  ...
  800408:	50                   	push   %eax
  800409:	68 27 1e 80 00       	push   $0x801e27
  80040e:	56                   	push   %esi
  80040f:	53                   	push   %ebx
  ...
  80042a:	b8 20 1e 80 00       	mov    $0x801e20,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a7e:	68 1f 21 80 00       	push   $0x80211f
  800a83:	6a 23                	push   $0x23
  800a85:	68 3c 21 80 00       	push   $0x80213c
  800a8a:	e8 51 0f 00 00       	call   8019e0 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800d81:	ba c8 21 80 00       	mov    $0x8021c8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800da3:	51                   	push   %ecx
  800da4:	50                   	push   %eax
  800da5:	68 4c 21 80 00       	push   $0x80214c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801011:	53                   	push   %ebx
  801012:	50                   	push   %eax
  801013:	68 8d 21 80 00       	push   $0x80218d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8010e2:	53                   	push   %ebx
  8010e3:	50                   	push   %eax
  8010e4:	68 a9 21 80 00       	push   $0x8021a9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801192:	53                   	push   %ebx
  801193:	50                   	push   %eax
  801194:	68 6c 21 80 00       	push   $0x80216c
...
stat(const char *path, struct Stat *stat)
{
  ...
  801238:	e8 fb 01 00 00       	call   801438 <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  80128a:	e8 09 08 00 00       	call   801a98 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  80128f:	83 c4 0c             	add    $0xc,%esp
  801292:	6a 00                	push   $0x0
  801294:	53                   	push   %ebx
  801295:	6a 00                	push   $0x0
  801297:	e8 8e 07 00 00       	call   801a2a <ipc_recv>
}
  ...
  8012a8:	e8 50 08 00 00       	call   801afd <ipc_find_env>
...
00801368 <devfile_write>:
{
  ...
  801386:	ba f8 0f 00 00       	mov    $0xff8,%edx
  80138b:	0f 47 c2             	cmova  %edx,%eax
  80138e:	a3 04 50 80 00       	mov    %eax,0x805004
	memmove(fsipcbuf.write.req_buf, buf, fsipcbuf.write.req_n);
  801393:	50                   	push   %eax
  801394:	ff 75 0c             	pushl  0xc(%ebp)
  801397:	68 08 50 80 00       	push   $0x805008
  80139c:	e8 e9 f4 ff ff       	call   80088a <memmove>
	return fsipc(FSREQ_WRITE, NULL);
  8013a1:	ba 00 00 00 00       	mov    $0x0,%edx
  8013a6:	b8 04 00 00 00       	mov    $0x4,%eax
  8013ab:	e8 ba fe ff ff       	call   80126a <fsipc>
}
  8013b0:	c9                   	leave  
  8013b1:	c3                   	ret    

008013b2 <devfile_read>:
{
  ...
  8013b9:	56                   	push   %esi
  8013ba:	53                   	push   %ebx
  8013bb:	8b 75 10             	mov    0x10(%ebp),%esi
	fsipcbuf.read.req_fileid = fd->fd_file.id;
  8013be:	8b 45 08             	mov    0x8(%ebp),%eax
  8013c1:	8b 40 0c             	mov    0xc(%eax),%eax
  8013c4:	a3 00 50 80 00       	mov    %eax,0x805000
	fsipcbuf.read.req_n = n;
  8013c9:	89 35 04 50 80 00    	mov    %esi,0x805004
	if ((r = fsipc(FSREQ_READ, NULL)) < 0)
  8013cf:	ba 00 00 00 00       	mov    $0x0,%edx
  8013d4:	b8 03 00 00 00       	mov    $0x3,%eax
  8013d9:	e8 8c fe ff ff       	call   80126a <fsipc>
  8013de:	89 c3                	mov    %eax,%ebx
  8013e0:	85 c0                	test   %eax,%eax
  8013e2:	78 1f                	js     801403 <devfile_read+0x51>
	assert(r <= n);
  8013e4:	39 f0                	cmp    %esi,%eax
  8013e6:	77 24                	ja     80140c <devfile_read+0x5a>
	assert(r <= PGSIZE);
  8013e8:	3d 00 10 00 00       	cmp    $0x1000,%eax
  8013ed:	7f 33                	jg     801422 <devfile_read+0x70>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  8013ef:	83 ec 04             	sub    $0x4,%esp
  8013f2:	50                   	push   %eax
  8013f3:	68 00 50 80 00       	push   $0x805000
  8013f8:	ff 75 0c             	pushl  0xc(%ebp)
  8013fb:	e8 8a f4 ff ff       	call   80088a <memmove>
	return r;
  ...
  80140b:	c3                   	ret    
	assert(r <= n);
  80140c:	68 d8 21 80 00       	push   $0x8021d8
  801411:	68 df 21 80 00       	push   $0x8021df
  801416:	6a 7c                	push   $0x7c
  801418:	68 f4 21 80 00       	push   $0x8021f4
  80141d:	e8 be 05 00 00       	call   8019e0 <_panic>
	assert(r <= PGSIZE);
  801422:	68 ff 21 80 00       	push   $0x8021ff
  801427:	68 df 21 80 00       	push   $0x8021df
  80142c:	6a 7d                	push   $0x7d
  80142e:	68 f4 21 80 00       	push   $0x8021f4
  801433:	e8 a8 05 00 00       	call   8019e0 <_panic>
...
00801438 <open>:
{
  ...
  8014b9:	e8 10 f9 ff ff       	call   800dce <fd_close>
		return r;
  8014be:	83 c4 10             	add    $0x10,%esp
  8014c1:	eb e5                	jmp    8014a8 <open+0x70>
		return -E_BAD_PATH;
  8014c3:	bb f4 ff ff ff       	mov    $0xfffffff4,%ebx
  8014c8:	eb de                	jmp    8014a8 <open+0x70>
...
sync(void)
{
  ...
  8014de:	e8 87 fd ff ff       	call   80126a <fsipc>
}
  8014e3:	c9                   	leave  
  8014e4:	c3                   	ret    
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8014f7:	e8 af f7 ff ff       	call   800cab <fd2data>
  8014fc:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  8014fe:	83 c4 08             	add    $0x8,%esp
  801501:	68 0b 22 80 00       	push   $0x80220b
  801506:	53                   	push   %ebx
  801507:	e8 c6 f1 ff ff       	call   8006d2 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  80150c:	8b 46 04             	mov    0x4(%esi),%eax
  80150f:	2b 06                	sub    (%esi),%eax
  801511:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  801517:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  80151e:	00 00 00 
	stat->st_dev = &devpipe;
  801521:	c7 83 88 00 00 00 20 	movl   $0x803020,0x88(%ebx)
  801528:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  801548:	e8 5f f6 ff ff       	call   800bac <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  80154d:	89 1c 24             	mov    %ebx,(%esp)
  801550:	e8 56 f7 ff ff       	call   800cab <fd2data>
  801555:	83 c4 08             	add    $0x8,%esp
  801558:	50                   	push   %eax
  801559:	6a 00                	push   $0x0
  80155b:	e8 4c f6 ff ff       	call   800bac <sys_page_unmap>
}
...
00801565 <_pipeisclosed>:
{
  ...
  80157d:	57                   	push   %edi
  80157e:	e8 b7 05 00 00       	call   801b3a <pageref>
  801583:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  801586:	89 34 24             	mov    %esi,(%esp)
  801589:	e8 ac 05 00 00       	call   801b3a <pageref>
		nn = thisenv->env_runs;
  80158e:	8b 15 04 40 80 00    	mov    0x804004,%edx
  ...
  8015a8:	50                   	push   %eax
  8015a9:	53                   	push   %ebx
  8015aa:	68 12 22 80 00       	push   $0x802212
  8015af:	e8 b4 eb ff ff       	call   800168 <cprintf>
...
008015ca <devpipe_write>:
{
  ...
  8015da:	56                   	push   %esi
  8015db:	e8 cb f6 ff ff       	call   800cab <fd2data>
  8015e0:	89 c3                	mov    %eax,%ebx
	for (i = 0; i < n; i++) {
  8015e2:	83 c4 10             	add    $0x10,%esp
  8015e5:	bf 00 00 00 00       	mov    $0x0,%edi
  8015ea:	3b 7d 10             	cmp    0x10(%ebp),%edi
  8015ed:	74 4f                	je     80163e <devpipe_write+0x74>
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  8015ef:	8b 43 04             	mov    0x4(%ebx),%eax
  8015f2:	8b 0b                	mov    (%ebx),%ecx
  8015f4:	8d 51 20             	lea    0x20(%ecx),%edx
  8015f7:	39 d0                	cmp    %edx,%eax
  8015f9:	72 14                	jb     80160f <devpipe_write+0x45>
			if (_pipeisclosed(fd, p))
  8015fb:	89 da                	mov    %ebx,%edx
  8015fd:	89 f0                	mov    %esi,%eax
  8015ff:	e8 61 ff ff ff       	call   801565 <_pipeisclosed>
  801604:	85 c0                	test   %eax,%eax
  801606:	75 3b                	jne    801643 <devpipe_write+0x79>
			sys_yield();
  801608:	e8 22 f5 ff ff       	call   800b2f <sys_yield>
  80160d:	eb e0                	jmp    8015ef <devpipe_write+0x25>
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
  80160f:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801612:	0f b6 0c 39          	movzbl (%ecx,%edi,1),%ecx
  801616:	88 4d e7             	mov    %cl,-0x19(%ebp)
  801619:	89 c2                	mov    %eax,%edx
  80161b:	c1 fa 1f             	sar    $0x1f,%edx
  80161e:	89 d1                	mov    %edx,%ecx
  801620:	c1 e9 1b             	shr    $0x1b,%ecx
  801623:	8d 14 08             	lea    (%eax,%ecx,1),%edx
  801626:	83 e2 1f             	and    $0x1f,%edx
  801629:	29 ca                	sub    %ecx,%edx
  80162b:	0f b6 4d e7          	movzbl -0x19(%ebp),%ecx
  80162f:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
		p->p_wpos++;
  801633:	83 c0 01             	add    $0x1,%eax
  801636:	89 43 04             	mov    %eax,0x4(%ebx)
	for (i = 0; i < n; i++) {
  801639:	83 c7 01             	add    $0x1,%edi
  80163c:	eb ac                	jmp    8015ea <devpipe_write+0x20>
	return i;
  80163e:	8b 45 10             	mov    0x10(%ebp),%eax
  801641:	eb 05                	jmp    801648 <devpipe_write+0x7e>
				return 0;
...
00801650 <devpipe_read>:
{
  ...
  80165d:	8b 7d 08             	mov    0x8(%ebp),%edi
	p = (struct Pipe*)fd2data(fd);
  801660:	57                   	push   %edi
  801661:	e8 45 f6 ff ff       	call   800cab <fd2data>
  801666:	89 c3                	mov    %eax,%ebx
	for (i = 0; i < n; i++) {
  801668:	83 c4 10             	add    $0x10,%esp
  80166b:	be 00 00 00 00       	mov    $0x0,%esi
  801670:	3b 75 10             	cmp    0x10(%ebp),%esi
  801673:	75 14                	jne    801689 <devpipe_read+0x39>
	return i;
  801675:	8b 45 10             	mov    0x10(%ebp),%eax
  801678:	eb 02                	jmp    80167c <devpipe_read+0x2c>
				return i;
  ...
  801683:	c3                   	ret    
			sys_yield();
  801684:	e8 a6 f4 ff ff       	call   800b2f <sys_yield>
		while (p->p_rpos == p->p_wpos) {
  801689:	8b 03                	mov    (%ebx),%eax
  80168b:	3b 43 04             	cmp    0x4(%ebx),%eax
  80168e:	75 18                	jne    8016a8 <devpipe_read+0x58>
			if (i > 0)
  801690:	85 f6                	test   %esi,%esi
  801692:	75 e6                	jne    80167a <devpipe_read+0x2a>
			if (_pipeisclosed(fd, p))
  801694:	89 da                	mov    %ebx,%edx
  801696:	89 f8                	mov    %edi,%eax
  801698:	e8 c8 fe ff ff       	call   801565 <_pipeisclosed>
  80169d:	85 c0                	test   %eax,%eax
  80169f:	74 e3                	je     801684 <devpipe_read+0x34>
				return 0;
  8016a1:	b8 00 00 00 00       	mov    $0x0,%eax
  8016a6:	eb d4                	jmp    80167c <devpipe_read+0x2c>
		buf[i] = p->p_buf[p->p_rpos % PIPEBUFSIZ];
  8016a8:	99                   	cltd   
  8016a9:	c1 ea 1b             	shr    $0x1b,%edx
  8016ac:	01 d0                	add    %edx,%eax
  8016ae:	83 e0 1f             	and    $0x1f,%eax
  8016b1:	29 d0                	sub    %edx,%eax
  8016b3:	0f b6 44 03 08       	movzbl 0x8(%ebx,%eax,1),%eax
  8016b8:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8016bb:	88 04 31             	mov    %al,(%ecx,%esi,1)
		p->p_rpos++;
  8016be:	83 03 01             	addl   $0x1,(%ebx)
	for (i = 0; i < n; i++) {
  8016c1:	83 c6 01             	add    $0x1,%esi
  8016c4:	eb aa                	jmp    801670 <devpipe_read+0x20>
...
00801814 <pipeisclosed>:
{
  ...
  801825:	e8 f6 f4 ff ff       	call   800d20 <fd_lookup>
  80182a:	83 c4 10             	add    $0x10,%esp
  80182d:	85 c0                	test   %eax,%eax
  80182f:	78 18                	js     801849 <pipeisclosed+0x35>
	p = (struct Pipe*) fd2data(fd);
  801831:	83 ec 0c             	sub    $0xc,%esp
  801834:	ff 75 f4             	pushl  -0xc(%ebp)
  801837:	e8 6f f4 ff ff       	call   800cab <fd2data>
  80183c:	89 c2                	mov    %eax,%edx
	return _pipeisclosed(fd, p);
  80183e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801841:	e8 1f fd ff ff       	call   801565 <_pipeisclosed>
  801846:	83 c4 10             	add    $0x10,%esp
}
  801849:	c9                   	leave  
  80184a:	c3                   	ret    

0080184b <devcons_close>:
	return tot;
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801867:	e8 66 ee ff ff       	call   8006d2 <strcpy>
	return 0;
}
...
00801873 <devcons_write>:
{
  ...
  80187b:	56                   	push   %esi
  80187c:	53                   	push   %ebx
  80187d:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	for (tot = 0; tot < n; tot += m) {
  801883:	be 00 00 00 00       	mov    $0x0,%esi
		memmove(buf, (char*)vbuf + tot, m);
  801888:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	for (tot = 0; tot < n; tot += m) {
  80188e:	3b 75 10             	cmp    0x10(%ebp),%esi
  801891:	73 31                	jae    8018c4 <devcons_write+0x51>
		m = n - tot;
  801893:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801896:	29 f3                	sub    %esi,%ebx
  801898:	83 fb 7f             	cmp    $0x7f,%ebx
  80189b:	b8 7f 00 00 00       	mov    $0x7f,%eax
  8018a0:	0f 47 d8             	cmova  %eax,%ebx
		memmove(buf, (char*)vbuf + tot, m);
  ...
  8018ac:	50                   	push   %eax
  8018ad:	57                   	push   %edi
  8018ae:	e8 d7 ef ff ff       	call   80088a <memmove>
		sys_cputs(buf, m);
  8018b3:	83 c4 08             	add    $0x8,%esp
  8018b6:	53                   	push   %ebx
  8018b7:	57                   	push   %edi
  8018b8:	e8 d2 f1 ff ff       	call   800a8f <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
  8018bd:	01 de                	add    %ebx,%esi
  8018bf:	83 c4 10             	add    $0x10,%esp
  8018c2:	eb ca                	jmp    80188e <devcons_write+0x1b>
}
...
008018ce <devcons_read>:
{
  ...
  8018d8:	b8 00 00 00 00       	mov    $0x0,%eax
	if (n == 0)
  8018dd:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
  8018e1:	74 21                	je     801904 <devcons_read+0x36>
	while ((c = sys_cgetc()) == 0)
  8018e3:	e8 d1 f1 ff ff       	call   800ab9 <sys_cgetc>
  8018e8:	85 c0                	test   %eax,%eax
  8018ea:	75 07                	jne    8018f3 <devcons_read+0x25>
		sys_yield();
  8018ec:	e8 3e f2 ff ff       	call   800b2f <sys_yield>
  8018f1:	eb f0                	jmp    8018e3 <devcons_read+0x15>
	if (c < 0)
  8018f3:	78 0f                	js     801904 <devcons_read+0x36>
	if (c == 0x04)	// ctl-d is eof
  8018f5:	83 f8 04             	cmp    $0x4,%eax
  8018f8:	74 0c                	je     801906 <devcons_read+0x38>
	*(char*)vbuf = c;
  ...
  80190b:	eb f7                	jmp    801904 <devcons_read+0x36>
...
0080190d <cputchar>:
{
  ...
  80191a:	88 45 f7             	mov    %al,-0x9(%ebp)
	sys_cputs(&c, 1);
  80191d:	6a 01                	push   $0x1
  80191f:	8d 45 f7             	lea    -0x9(%ebp),%eax
  801922:	50                   	push   %eax
  801923:	e8 67 f1 ff ff       	call   800a8f <sys_cputs>
}
...
0080192d <getchar>:
{
  ...
  801939:	8d 45 f7             	lea    -0x9(%ebp),%eax
  80193c:	50                   	push   %eax
  80193d:	6a 00                	push   $0x0
  80193f:	e8 5f f6 ff ff       	call   800fa3 <read>
	if (r < 0)
  801944:	83 c4 10             	add    $0x10,%esp
  801947:	85 c0                	test   %eax,%eax
  801949:	78 06                	js     801951 <getchar+0x24>
	if (r < 1)
  80194b:	74 06                	je     801953 <getchar+0x26>
	return c;
  80194d:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
}
  801951:	c9                   	leave  
  801952:	c3                   	ret    
		return -E_EOF;
  801953:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
  801958:	eb f7                	jmp    801951 <getchar+0x24>
...
0080195a <iscons>:
{
  ...
  80196b:	e8 b0 f3 ff ff       	call   800d20 <fd_lookup>
  801970:	83 c4 10             	add    $0x10,%esp
  801973:	85 c0                	test   %eax,%eax
  801975:	78 11                	js     801988 <iscons+0x2e>
	return fd->fd_dev_id == devcons.dev_id;
  801977:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80197a:	8b 15 3c 30 80 00    	mov    0x80303c,%edx
  801980:	39 10                	cmp    %edx,(%eax)
  801982:	0f 94 c0             	sete   %al
  801985:	0f b6 c0             	movzbl %al,%eax
}
  801988:	c9                   	leave  
  801989:	c3                   	ret    
...
0080198a <opencons>:
{
  ...
  8019d5:	50                   	push   %eax
  8019d6:	e8 bc f2 ff ff       	call   800c97 <fd2num>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019f2:	e8 10 f1 ff ff       	call   800b07 <sys_getenvid>
  8019f7:	83 ec 0c             	sub    $0xc,%esp
  8019fa:	ff 75 0c             	pushl  0xc(%ebp)
  8019fd:	ff 75 08             	pushl  0x8(%ebp)
  801a00:	56                   	push   %esi
  801a01:	50                   	push   %eax
  801a02:	68 38 22 80 00       	push   $0x802238
  801a07:	e8 5c e7 ff ff       	call   800168 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801a0c:	83 c4 18             	add    $0x18,%esp
  801a0f:	53                   	push   %ebx
  801a10:	ff 75 10             	pushl  0x10(%ebp)
  801a13:	e8 fb e6 ff ff       	call   800113 <vcprintf>
	cprintf("\n");
  801a18:	c7 04 24 23 22 80 00 	movl   $0x802223,(%esp)
  801a1f:	e8 44 e7 ff ff       	call   800168 <cprintf>
  801a24:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  801a27:	cc                   	int3   
  801a28:	eb fd                	jmp    801a27 <_panic+0x47>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a3e:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801a43:	0f 44 c2             	cmove  %edx,%eax
  801a46:	83 ec 0c             	sub    $0xc,%esp
  801a49:	50                   	push   %eax
  801a4a:	e8 22 f2 ff ff       	call   800c71 <sys_ipc_recv>

	if (from_env_store != NULL)
  801a4f:	83 c4 10             	add    $0x10,%esp
  801a52:	85 f6                	test   %esi,%esi
  801a54:	74 15                	je     801a6b <ipc_recv+0x41>
		*from_env_store = err ? 0 : thisenv->env_ipc_from;
  801a56:	ba 00 00 00 00       	mov    $0x0,%edx
  801a5b:	83 f8 fd             	cmp    $0xfffffffd,%eax
  801a5e:	74 09                	je     801a69 <ipc_recv+0x3f>
  ...
  801a6d:	74 15                	je     801a84 <ipc_recv+0x5a>
		*perm_store = err ? 0 : thisenv->env_ipc_perm;
  801a6f:	ba 00 00 00 00       	mov    $0x0,%edx
  801a74:	83 f8 fd             	cmp    $0xfffffffd,%eax
  801a77:	74 09                	je     801a82 <ipc_recv+0x58>
  801a79:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801a7f:	8b 52 78             	mov    0x78(%edx),%edx
  801a82:	89 13                	mov    %edx,(%ebx)

	return err ? -E_INVAL : thisenv->env_ipc_value;
  801a84:	83 f8 fd             	cmp    $0xfffffffd,%eax
  801a87:	74 08                	je     801a91 <ipc_recv+0x67>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801aae:	eb 1f                	jmp    801acf <ipc_send+0x37>
	int res;
	while (true) {
		if (pg != NULL) {
  ...
  801ab7:	56                   	push   %esi
  801ab8:	57                   	push   %edi
  801ab9:	e8 8a f1 ff ff       	call   800c48 <sys_ipc_try_send>
  801abe:	83 c4 10             	add    $0x10,%esp
		}

		if (res == 0)
  801ac1:	85 c0                	test   %eax,%eax
  801ac3:	74 30                	je     801af5 <ipc_send+0x5d>
			return;
		if (res != -E_IPC_NOT_RECV)
  801ac5:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801ac8:	75 19                	jne    801ae3 <ipc_send+0x4b>
			panic("ipc_send: %d", res);
		sys_yield();
  801aca:	e8 60 f0 ff ff       	call   800b2f <sys_yield>
		if (pg != NULL) {
  801acf:	85 db                	test   %ebx,%ebx
  801ad1:	74 dd                	je     801ab0 <ipc_send+0x18>
			res = sys_ipc_try_send(to_env, val, pg, perm);
  801ad3:	ff 75 14             	pushl  0x14(%ebp)
  801ad6:	53                   	push   %ebx
  801ad7:	56                   	push   %esi
  801ad8:	57                   	push   %edi
  801ad9:	e8 6a f1 ff ff       	call   800c48 <sys_ipc_try_send>
  801ade:	83 c4 10             	add    $0x10,%esp
  801ae1:	eb de                	jmp    801ac1 <ipc_send+0x29>
			panic("ipc_send: %d", res);
  801ae3:	50                   	push   %eax
  801ae4:	68 5b 22 80 00       	push   $0x80225b
  801ae9:	6a 3e                	push   $0x3e
  801aeb:	68 68 22 80 00       	push   $0x802268
  801af0:	e8 eb fe ff ff       	call   8019e0 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801b0c:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801b0f:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801b15:	8b 52 50             	mov    0x50(%edx),%edx
  801b18:	39 ca                	cmp    %ecx,%edx
  801b1a:	74 11                	je     801b2d <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801b1c:	83 c0 01             	add    $0x1,%eax
  801b1f:	3d 00 04 00 00       	cmp    $0x400,%eax
  801b24:	75 e6                	jne    801b0c <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801b26:	b8 00 00 00 00       	mov    $0x0,%eax
  801b2b:	eb 0b                	jmp    801b38 <ipc_find_env+0x3b>
			return envs[i].env_id;
  801b2d:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801b30:	05 00 00 c0 ee       	add    $0xeec00000,%eax
...
pageref(void *v)
{
  ...
  801b46:	c1 ea 16             	shr    $0x16,%edx
  801b49:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801b50:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801b55:	f6 c1 01             	test   $0x1,%cl
  801b58:	74 1c                	je     801b76 <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801b5a:	c1 e8 0c             	shr    $0xc,%eax
  801b5d:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801b64:	a8 01                	test   $0x1,%al
  801b66:	74 0e                	je     801b76 <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801b68:	c1 e8 0c             	shr    $0xc,%eax
  801b6b:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801b72:	ef 
  801b73:	0f b7 d2             	movzwl %dx,%edx
}
