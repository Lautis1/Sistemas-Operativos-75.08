...
num(int f, const char *s)
{
  ...
  80005d:	e8 01 17 00 00       	call   801763 <printf>
			bol = 0;
...
umain(int argc, char **argv)
{
  ...
  800124:	e8 83 14 00 00       	call   8015ac <open>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800342:	e8 89 1a 00 00       	call   801dd0 <__udivdi3>
  ...
  800380:	e8 5b 1b 00 00       	call   801ee0 <__umoddi3>
...
stat(const char *path, struct Stat *stat)
{
  ...
  8013ac:	e8 fb 01 00 00       	call   8015ac <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013fe:	e8 e3 08 00 00       	call   801ce6 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  801403:	83 c4 0c             	add    $0xc,%esp
  801406:	6a 00                	push   $0x0
  801408:	53                   	push   %ebx
  801409:	6a 00                	push   $0x0
  80140b:	e8 68 08 00 00       	call   801c78 <ipc_recv>
}
  ...
  80141c:	e8 2a 09 00 00       	call   801d4b <ipc_find_env>
...
00801526 <devfile_read>:
{
  ...
  80154d:	e8 8c fe ff ff       	call   8013de <fsipc>
  801552:	89 c3                	mov    %eax,%ebx
  801554:	85 c0                	test   %eax,%eax
  801556:	78 1f                	js     801577 <devfile_read+0x51>
	assert(r <= n);
  801558:	39 f0                	cmp    %esi,%eax
  80155a:	77 24                	ja     801580 <devfile_read+0x5a>
	assert(r <= PGSIZE);
  80155c:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801561:	7f 33                	jg     801596 <devfile_read+0x70>
	memmove(buf, fsipcbuf.readRet.ret_buf, r);
  801563:	83 ec 04             	sub    $0x4,%esp
  801566:	50                   	push   %eax
  801567:	68 00 50 80 00       	push   $0x805000
  80156c:	ff 75 0c             	pushl  0xc(%ebp)
  80156f:	e8 8a f4 ff ff       	call   8009fe <memmove>
	return r;
  ...
  80157f:	c3                   	ret    
	assert(r <= n);
  801580:	68 78 24 80 00       	push   $0x802478
  801585:	68 7f 24 80 00       	push   $0x80247f
  80158a:	6a 7c                	push   $0x7c
  80158c:	68 94 24 80 00       	push   $0x802494
  801591:	e8 5f ec ff ff       	call   8001f5 <_panic>
	assert(r <= PGSIZE);
  801596:	68 9f 24 80 00       	push   $0x80249f
  80159b:	68 7f 24 80 00       	push   $0x80247f
  8015a0:	6a 7d                	push   $0x7d
  8015a2:	68 94 24 80 00       	push   $0x802494
  8015a7:	e8 49 ec ff ff       	call   8001f5 <_panic>
...
008015ac <open>:
{
  ...
  80162d:	e8 10 f9 ff ff       	call   800f42 <fd_close>
		return r;
  801632:	83 c4 10             	add    $0x10,%esp
  801635:	eb e5                	jmp    80161c <open+0x70>
		return -E_BAD_PATH;
  801637:	bb f4 ff ff ff       	mov    $0xfffffff4,%ebx
  80163c:	eb de                	jmp    80161c <open+0x70>
...
sync(void)
{
  ...
  801652:	e8 87 fd ff ff       	call   8013de <fsipc>
}
  801657:	c9                   	leave  
  801658:	c3                   	ret    
...
{
	if (b->error > 0) {
  801659:	83 78 0c 00          	cmpl   $0x0,0xc(%eax)
  80165d:	7f 01                	jg     801660 <writebuf+0x7>
  80165f:	c3                   	ret    
{
  801660:	55                   	push   %ebp
  ...
  801669:	ff 70 04             	pushl  0x4(%eax)
  80166c:	8d 40 10             	lea    0x10(%eax),%eax
  80166f:	50                   	push   %eax
  801670:	ff 33                	pushl  (%ebx)
  801672:	e8 76 fb ff ff       	call   8011ed <write>
		if (result > 0)
  801677:	83 c4 10             	add    $0x10,%esp
  80167a:	85 c0                	test   %eax,%eax
  80167c:	7e 03                	jle    801681 <writebuf+0x28>
			b->result += result;
  80167e:	01 43 08             	add    %eax,0x8(%ebx)
		if (result != b->idx) // error, or wrote less than supplied
  801681:	39 43 04             	cmp    %eax,0x4(%ebx)
  801684:	74 0d                	je     801693 <writebuf+0x3a>
			b->error = (result < 0 ? result : 0);
  801686:	85 c0                	test   %eax,%eax
  801688:	ba 00 00 00 00       	mov    $0x0,%edx
  80168d:	0f 4f c2             	cmovg  %edx,%eax
  801690:	89 43 0c             	mov    %eax,0xc(%ebx)
	}
}
...
putch(int ch, void *thunk)
{
  ...
  8016a3:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	b->buf[b->idx++] = ch;
  8016a6:	8b 53 04             	mov    0x4(%ebx),%edx
  8016a9:	8d 42 01             	lea    0x1(%edx),%eax
  8016ac:	89 43 04             	mov    %eax,0x4(%ebx)
  8016af:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8016b2:	88 4c 13 10          	mov    %cl,0x10(%ebx,%edx,1)
	if (b->idx == 256) {
  8016b6:	3d 00 01 00 00       	cmp    $0x100,%eax
  8016bb:	74 06                	je     8016c3 <putch+0x2b>
		writebuf(b);
		b->idx = 0;
	}
}
  ...
  8016c5:	e8 8f ff ff ff       	call   801659 <writebuf>
		b->idx = 0;
  8016ca:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
  8016d1:	eb ea                	jmp    8016bd <putch+0x25>
...
vfprintf(int fd, const char *fmt, va_list ap)
{
  ...
  8016da:	81 ec 18 01 00 00    	sub    $0x118,%esp
	struct printbuf b;

	b.fd = fd;
  8016e0:	8b 45 08             	mov    0x8(%ebp),%eax
  8016e3:	89 85 e8 fe ff ff    	mov    %eax,-0x118(%ebp)
	b.idx = 0;
  8016e9:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%ebp)
  8016f0:	00 00 00 
	b.result = 0;
  8016f3:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  8016fa:	00 00 00 
	b.error = 1;
  8016fd:	c7 85 f4 fe ff ff 01 	movl   $0x1,-0x10c(%ebp)
  801704:	00 00 00 
	vprintfmt(putch, &b, fmt, ap);
  801707:	ff 75 10             	pushl  0x10(%ebp)
  80170a:	ff 75 0c             	pushl  0xc(%ebp)
  80170d:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  801713:	50                   	push   %eax
  801714:	68 98 16 80 00       	push   $0x801698
  801719:	e8 21 ed ff ff       	call   80043f <vprintfmt>
	if (b.idx > 0)
  80171e:	83 c4 10             	add    $0x10,%esp
  801721:	83 bd ec fe ff ff 00 	cmpl   $0x0,-0x114(%ebp)
  801728:	7f 11                	jg     80173b <vfprintf+0x68>
		writebuf(&b);

	return (b.result ? b.result : b.error);
  80172a:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  801730:	85 c0                	test   %eax,%eax
  801732:	0f 44 85 f4 fe ff ff 	cmove  -0x10c(%ebp),%eax
}
  801739:	c9                   	leave  
  80173a:	c3                   	ret    
		writebuf(&b);
  80173b:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  801741:	e8 13 ff ff ff       	call   801659 <writebuf>
  801746:	eb e2                	jmp    80172a <vfprintf+0x57>
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  80175c:	e8 72 ff ff ff       	call   8016d3 <vfprintf>
	va_end(ap);
...
printf(const char *fmt, ...)
{
  ...
  80176a:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  80176d:	8d 45 0c             	lea    0xc(%ebp),%eax
	cnt = vfprintf(1, fmt, ap);
  801770:	50                   	push   %eax
  801771:	ff 75 08             	pushl  0x8(%ebp)
  801774:	6a 01                	push   $0x1
  801776:	e8 58 ff ff ff       	call   8016d3 <vfprintf>
	va_end(ap);
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80178f:	e8 8b f6 ff ff       	call   800e1f <fd2data>
  801794:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801796:	83 c4 08             	add    $0x8,%esp
  801799:	68 ab 24 80 00       	push   $0x8024ab
  80179e:	53                   	push   %ebx
  80179f:	e8 a2 f0 ff ff       	call   800846 <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  8017a4:	8b 46 04             	mov    0x4(%esi),%eax
  8017a7:	2b 06                	sub    (%esi),%eax
  8017a9:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  8017af:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  8017b6:	00 00 00 
	stat->st_dev = &devpipe;
  8017b9:	c7 83 88 00 00 00 24 	movl   $0x803024,0x88(%ebx)
  8017c0:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  8017e0:	e8 3b f5 ff ff       	call   800d20 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  8017e5:	89 1c 24             	mov    %ebx,(%esp)
  8017e8:	e8 32 f6 ff ff       	call   800e1f <fd2data>
  8017ed:	83 c4 08             	add    $0x8,%esp
  8017f0:	50                   	push   %eax
  8017f1:	6a 00                	push   $0x0
  8017f3:	e8 28 f5 ff ff       	call   800d20 <sys_page_unmap>
}
...
008017fd <_pipeisclosed>:
{
  ...
  80180f:	8b 58 58             	mov    0x58(%eax),%ebx
		ret = pageref(fd) == pageref(p);
  801812:	83 ec 0c             	sub    $0xc,%esp
  801815:	57                   	push   %edi
  801816:	e8 6d 05 00 00       	call   801d88 <pageref>
  80181b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  80181e:	89 34 24             	mov    %esi,(%esp)
  801821:	e8 62 05 00 00       	call   801d88 <pageref>
		nn = thisenv->env_runs;
  801826:	8b 15 08 40 80 00    	mov    0x804008,%edx
  80182c:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  80182f:	83 c4 10             	add    $0x10,%esp
  801832:	39 cb                	cmp    %ecx,%ebx
  801834:	74 1b                	je     801851 <_pipeisclosed+0x54>
		if (n != nn && ret == 1)
  801836:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801839:	75 cf                	jne    80180a <_pipeisclosed+0xd>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  80183b:	8b 42 58             	mov    0x58(%edx),%eax
  80183e:	6a 01                	push   $0x1
  801840:	50                   	push   %eax
  801841:	53                   	push   %ebx
  801842:	68 b2 24 80 00       	push   $0x8024b2
  801847:	e8 90 ea ff ff       	call   8002dc <cprintf>
  80184c:	83 c4 10             	add    $0x10,%esp
  80184f:	eb b9                	jmp    80180a <_pipeisclosed+0xd>
		ret = pageref(fd) == pageref(p);
  801851:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801854:	0f 94 c0             	sete   %al
...
00801862 <devpipe_write>:
{
  ...
  801872:	56                   	push   %esi
  801873:	e8 a7 f5 ff ff       	call   800e1f <fd2data>
  801878:	89 c3                	mov    %eax,%ebx
	for (i = 0; i < n; i++) {
  80187a:	83 c4 10             	add    $0x10,%esp
  80187d:	bf 00 00 00 00       	mov    $0x0,%edi
  801882:	3b 7d 10             	cmp    0x10(%ebp),%edi
  801885:	74 4f                	je     8018d6 <devpipe_write+0x74>
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  801887:	8b 43 04             	mov    0x4(%ebx),%eax
  80188a:	8b 0b                	mov    (%ebx),%ecx
  80188c:	8d 51 20             	lea    0x20(%ecx),%edx
  80188f:	39 d0                	cmp    %edx,%eax
  801891:	72 14                	jb     8018a7 <devpipe_write+0x45>
			if (_pipeisclosed(fd, p))
  801893:	89 da                	mov    %ebx,%edx
  801895:	89 f0                	mov    %esi,%eax
  801897:	e8 61 ff ff ff       	call   8017fd <_pipeisclosed>
  80189c:	85 c0                	test   %eax,%eax
  80189e:	75 3b                	jne    8018db <devpipe_write+0x79>
			sys_yield();
  8018a0:	e8 fe f3 ff ff       	call   800ca3 <sys_yield>
  8018a5:	eb e0                	jmp    801887 <devpipe_write+0x25>
		p->p_buf[p->p_wpos % PIPEBUFSIZ] = buf[i];
  8018a7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8018aa:	0f b6 0c 39          	movzbl (%ecx,%edi,1),%ecx
  8018ae:	88 4d e7             	mov    %cl,-0x19(%ebp)
  8018b1:	89 c2                	mov    %eax,%edx
  8018b3:	c1 fa 1f             	sar    $0x1f,%edx
  8018b6:	89 d1                	mov    %edx,%ecx
  8018b8:	c1 e9 1b             	shr    $0x1b,%ecx
  8018bb:	8d 14 08             	lea    (%eax,%ecx,1),%edx
  8018be:	83 e2 1f             	and    $0x1f,%edx
  8018c1:	29 ca                	sub    %ecx,%edx
  8018c3:	0f b6 4d e7          	movzbl -0x19(%ebp),%ecx
  8018c7:	88 4c 13 08          	mov    %cl,0x8(%ebx,%edx,1)
		p->p_wpos++;
  8018cb:	83 c0 01             	add    $0x1,%eax
  8018ce:	89 43 04             	mov    %eax,0x4(%ebx)
	for (i = 0; i < n; i++) {
  8018d1:	83 c7 01             	add    $0x1,%edi
  8018d4:	eb ac                	jmp    801882 <devpipe_write+0x20>
	return i;
  8018d6:	8b 45 10             	mov    0x10(%ebp),%eax
  8018d9:	eb 05                	jmp    8018e0 <devpipe_write+0x7e>
				return 0;
...
008018e8 <devpipe_read>:
{
  ...
  80191b:	c3                   	ret    
			sys_yield();
  80191c:	e8 82 f3 ff ff       	call   800ca3 <sys_yield>
		while (p->p_rpos == p->p_wpos) {
  801921:	8b 03                	mov    (%ebx),%eax
  801923:	3b 43 04             	cmp    0x4(%ebx),%eax
  801926:	75 18                	jne    801940 <devpipe_read+0x58>
			if (i > 0)
  801928:	85 f6                	test   %esi,%esi
  80192a:	75 e6                	jne    801912 <devpipe_read+0x2a>
			if (_pipeisclosed(fd, p))
  80192c:	89 da                	mov    %ebx,%edx
  80192e:	89 f8                	mov    %edi,%eax
  801930:	e8 c8 fe ff ff       	call   8017fd <_pipeisclosed>
  801935:	85 c0                	test   %eax,%eax
  801937:	74 e3                	je     80191c <devpipe_read+0x34>
				return 0;
  801939:	b8 00 00 00 00       	mov    $0x0,%eax
  80193e:	eb d4                	jmp    801914 <devpipe_read+0x2c>
  ...
  80195c:	eb aa                	jmp    801908 <devpipe_read+0x20>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801af7:	68 ca 24 80 00       	push   $0x8024ca
  801afc:	ff 75 0c             	pushl  0xc(%ebp)
  801aff:	e8 42 ed ff ff       	call   800846 <strcpy>
	return 0;
}
...
00801b0b <devcons_write>:
{
  ...
  801b13:	56                   	push   %esi
  801b14:	53                   	push   %ebx
  801b15:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	for (tot = 0; tot < n; tot += m) {
  801b1b:	be 00 00 00 00       	mov    $0x0,%esi
		memmove(buf, (char*)vbuf + tot, m);
  801b20:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	for (tot = 0; tot < n; tot += m) {
  801b26:	3b 75 10             	cmp    0x10(%ebp),%esi
  801b29:	73 31                	jae    801b5c <devcons_write+0x51>
		m = n - tot;
  801b2b:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801b2e:	29 f3                	sub    %esi,%ebx
  801b30:	83 fb 7f             	cmp    $0x7f,%ebx
  801b33:	b8 7f 00 00 00       	mov    $0x7f,%eax
  801b38:	0f 47 d8             	cmova  %eax,%ebx
		memmove(buf, (char*)vbuf + tot, m);
  801b3b:	83 ec 04             	sub    $0x4,%esp
  801b3e:	53                   	push   %ebx
  801b3f:	89 f0                	mov    %esi,%eax
  801b41:	03 45 0c             	add    0xc(%ebp),%eax
  801b44:	50                   	push   %eax
  801b45:	57                   	push   %edi
  801b46:	e8 b3 ee ff ff       	call   8009fe <memmove>
		sys_cputs(buf, m);
  801b4b:	83 c4 08             	add    $0x8,%esp
  801b4e:	53                   	push   %ebx
  801b4f:	57                   	push   %edi
  801b50:	e8 ae f0 ff ff       	call   800c03 <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
  801b55:	01 de                	add    %ebx,%esi
  801b57:	83 c4 10             	add    $0x10,%esp
  801b5a:	eb ca                	jmp    801b26 <devcons_write+0x1b>
}
...
00801b66 <devcons_read>:
{
  ...
  801b79:	74 21                	je     801b9c <devcons_read+0x36>
	while ((c = sys_cgetc()) == 0)
  801b7b:	e8 ad f0 ff ff       	call   800c2d <sys_cgetc>
  801b80:	85 c0                	test   %eax,%eax
  801b82:	75 07                	jne    801b8b <devcons_read+0x25>
		sys_yield();
  801b84:	e8 1a f1 ff ff       	call   800ca3 <sys_yield>
  801b89:	eb f0                	jmp    801b7b <devcons_read+0x15>
	if (c < 0)
  801b8b:	78 0f                	js     801b9c <devcons_read+0x36>
  ...
  801ba3:	eb f7                	jmp    801b9c <devcons_read+0x36>
...
00801ba5 <cputchar>:
{
  ...
  801bb2:	88 45 f7             	mov    %al,-0x9(%ebp)
	sys_cputs(&c, 1);
  801bb5:	6a 01                	push   $0x1
  801bb7:	8d 45 f7             	lea    -0x9(%ebp),%eax
  801bba:	50                   	push   %eax
  801bbb:	e8 43 f0 ff ff       	call   800c03 <sys_cputs>
}
...
00801bc5 <getchar>:
{
  ...
  801bd7:	e8 3b f5 ff ff       	call   801117 <read>
	if (r < 0)
  801bdc:	83 c4 10             	add    $0x10,%esp
  801bdf:	85 c0                	test   %eax,%eax
  801be1:	78 06                	js     801be9 <getchar+0x24>
	if (r < 1)
  801be3:	74 06                	je     801beb <getchar+0x26>
	return c;
  801be5:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
}
  801be9:	c9                   	leave  
  801bea:	c3                   	ret    
		return -E_EOF;
  801beb:	b8 f8 ff ff ff       	mov    $0xfffffff8,%eax
  801bf0:	eb f7                	jmp    801be9 <getchar+0x24>
...
00801bf2 <iscons>:
{
  ...
  801c03:	e8 8c f2 ff ff       	call   800e94 <fd_lookup>
  801c08:	83 c4 10             	add    $0x10,%esp
  801c0b:	85 c0                	test   %eax,%eax
  801c0d:	78 11                	js     801c20 <iscons+0x2e>
...
00801c22 <opencons>:
{
  ...
  801c6d:	50                   	push   %eax
  801c6e:	e8 98 f1 ff ff       	call   800e0b <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801c8c:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801c91:	0f 44 c2             	cmove  %edx,%eax
  801c94:	83 ec 0c             	sub    $0xc,%esp
  801c97:	50                   	push   %eax
  801c98:	e8 48 f1 ff ff       	call   800de5 <sys_ipc_recv>

	if (from_env_store != NULL)
  801c9d:	83 c4 10             	add    $0x10,%esp
  801ca0:	85 f6                	test   %esi,%esi
  801ca2:	74 15                	je     801cb9 <ipc_recv+0x41>
		*from_env_store = err ? 0 : thisenv->env_ipc_from;
  801ca4:	ba 00 00 00 00       	mov    $0x0,%edx
  801ca9:	83 f8 fd             	cmp    $0xfffffffd,%eax
  801cac:	74 09                	je     801cb7 <ipc_recv+0x3f>
  801cae:	8b 15 08 40 80 00    	mov    0x804008,%edx
  801cb4:	8b 52 74             	mov    0x74(%edx),%edx
  801cb7:	89 16                	mov    %edx,(%esi)

	if (perm_store != NULL)
  801cb9:	85 db                	test   %ebx,%ebx
  801cbb:	74 15                	je     801cd2 <ipc_recv+0x5a>
		*perm_store = err ? 0 : thisenv->env_ipc_perm;
  801cbd:	ba 00 00 00 00       	mov    $0x0,%edx
  801cc2:	83 f8 fd             	cmp    $0xfffffffd,%eax
  801cc5:	74 09                	je     801cd0 <ipc_recv+0x58>
  801cc7:	8b 15 08 40 80 00    	mov    0x804008,%edx
  801ccd:	8b 52 78             	mov    0x78(%edx),%edx
  801cd0:	89 13                	mov    %edx,(%ebx)

	return err ? -E_INVAL : thisenv->env_ipc_value;
  801cd2:	83 f8 fd             	cmp    $0xfffffffd,%eax
  801cd5:	74 08                	je     801cdf <ipc_recv+0x67>
  801cd7:	a1 08 40 80 00       	mov    0x804008,%eax
  801cdc:	8b 40 70             	mov    0x70(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801cf6:	8b 75 0c             	mov    0xc(%ebp),%esi
  801cf9:	8b 5d 10             	mov    0x10(%ebp),%ebx
  801cfc:	eb 1f                	jmp    801d1d <ipc_send+0x37>
	int res;
	while (true) {
		if (pg != NULL) {
  ...
  801d00:	68 00 00 c0 ee       	push   $0xeec00000
  801d05:	56                   	push   %esi
  801d06:	57                   	push   %edi
  801d07:	e8 b0 f0 ff ff       	call   800dbc <sys_ipc_try_send>
  801d0c:	83 c4 10             	add    $0x10,%esp
		}

		if (res == 0)
  801d0f:	85 c0                	test   %eax,%eax
  801d11:	74 30                	je     801d43 <ipc_send+0x5d>
			return;
		if (res != -E_IPC_NOT_RECV)
  801d13:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d16:	75 19                	jne    801d31 <ipc_send+0x4b>
			panic("ipc_send: %d", res);
		sys_yield();
  801d18:	e8 86 ef ff ff       	call   800ca3 <sys_yield>
		if (pg != NULL) {
  801d1d:	85 db                	test   %ebx,%ebx
  801d1f:	74 dd                	je     801cfe <ipc_send+0x18>
			res = sys_ipc_try_send(to_env, val, pg, perm);
  801d21:	ff 75 14             	pushl  0x14(%ebp)
  801d24:	53                   	push   %ebx
  801d25:	56                   	push   %esi
  801d26:	57                   	push   %edi
  801d27:	e8 90 f0 ff ff       	call   800dbc <sys_ipc_try_send>
  801d2c:	83 c4 10             	add    $0x10,%esp
  801d2f:	eb de                	jmp    801d0f <ipc_send+0x29>
			panic("ipc_send: %d", res);
  801d31:	50                   	push   %eax
  801d32:	68 d6 24 80 00       	push   $0x8024d6
  801d37:	6a 3e                	push   $0x3e
  801d39:	68 e3 24 80 00       	push   $0x8024e3
  801d3e:	e8 b2 e4 ff ff       	call   8001f5 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801d68:	74 11                	je     801d7b <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801d6a:	83 c0 01             	add    $0x1,%eax
  801d6d:	3d 00 04 00 00       	cmp    $0x400,%eax
  801d72:	75 e6                	jne    801d5a <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801d74:	b8 00 00 00 00       	mov    $0x0,%eax
  801d79:	eb 0b                	jmp    801d86 <ipc_find_env+0x3b>
			return envs[i].env_id;
  801d7b:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801d7e:	05 00 00 c0 ee       	add    $0xeec00000,%eax
...
pageref(void *v)
{
  ...
  801d97:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801d9e:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801da3:	f6 c1 01             	test   $0x1,%cl
  801da6:	74 1c                	je     801dc4 <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801da8:	c1 e8 0c             	shr    $0xc,%eax
  801dab:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801db2:	a8 01                	test   $0x1,%al
  801db4:	74 0e                	je     801dc4 <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801db6:	c1 e8 0c             	shr    $0xc,%eax
  801db9:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801dc0:	ef 
  801dc1:	0f b7 d2             	movzwl %dx,%edx
}
...
00801dd0 <__udivdi3>:
  ...
  801ddb:	8b 54 24 3c          	mov    0x3c(%esp),%edx
  801ddf:	8b 6c 24 30          	mov    0x30(%esp),%ebp
  801de3:	8b 74 24 34          	mov    0x34(%esp),%esi
  801de7:	8b 5c 24 38          	mov    0x38(%esp),%ebx
  801deb:	85 d2                	test   %edx,%edx
  801ded:	75 19                	jne    801e08 <__udivdi3+0x38>
  801def:	39 f3                	cmp    %esi,%ebx
  801df1:	76 4d                	jbe    801e40 <__udivdi3+0x70>
  801df3:	31 ff                	xor    %edi,%edi
  801df5:	89 e8                	mov    %ebp,%eax
  801df7:	89 f2                	mov    %esi,%edx
  801df9:	f7 f3                	div    %ebx
  ...
  801e0a:	76 14                	jbe    801e20 <__udivdi3+0x50>
  ...
  801eb9:	72 15                	jb     801ed0 <__udivdi3+0x100>
  801ebb:	89 f9                	mov    %edi,%ecx
  801ebd:	d3 e5                	shl    %cl,%ebp
  801ebf:	39 c5                	cmp    %eax,%ebp
  801ec1:	73 04                	jae    801ec7 <__udivdi3+0xf7>
  801ec3:	39 d6                	cmp    %edx,%esi
  801ec5:	74 09                	je     801ed0 <__udivdi3+0x100>
  801ec7:	89 d8                	mov    %ebx,%eax
  801ec9:	31 ff                	xor    %edi,%edi
  801ecb:	e9 40 ff ff ff       	jmp    801e10 <__udivdi3+0x40>
  801ed0:	8d 43 ff             	lea    -0x1(%ebx),%eax
  801ed3:	31 ff                	xor    %edi,%edi
  801ed5:	e9 36 ff ff ff       	jmp    801e10 <__udivdi3+0x40>
...
00801ee0 <__umoddi3>:
  ...
  801eef:	8b 74 24 30          	mov    0x30(%esp),%esi
  801ef3:	8b 5c 24 34          	mov    0x34(%esp),%ebx
  ...
  801f01:	76 5d                	jbe    801f60 <__umoddi3+0x80>
  ...
  801f1a:	39 d8                	cmp    %ebx,%eax
  801f1c:	76 12                	jbe    801f30 <__umoddi3+0x50>
  ...
  801f36:	75 50                	jne    801f88 <__umoddi3+0xa8>
  801f38:	39 d8                	cmp    %ebx,%eax
  801f3a:	0f 82 e0 00 00 00    	jb     802020 <__umoddi3+0x140>
  801f40:	89 d9                	mov    %ebx,%ecx
  801f42:	39 f7                	cmp    %esi,%edi
  801f44:	0f 86 d6 00 00 00    	jbe    802020 <__umoddi3+0x140>
  801f4a:	89 d0                	mov    %edx,%eax
  801f4c:	89 ca                	mov    %ecx,%edx
  ...
  801f7f:	eb 8c                	jmp    801f0d <__umoddi3+0x2d>
  801f81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  801f88:	89 e9                	mov    %ebp,%ecx
  801f8a:	ba 20 00 00 00       	mov    $0x20,%edx
  801f8f:	29 ea                	sub    %ebp,%edx
  801f91:	d3 e0                	shl    %cl,%eax
  801f93:	89 44 24 08          	mov    %eax,0x8(%esp)
  801f97:	89 d1                	mov    %edx,%ecx
  801f99:	89 f8                	mov    %edi,%eax
  801f9b:	d3 e8                	shr    %cl,%eax
  801f9d:	8b 4c 24 08          	mov    0x8(%esp),%ecx
  801fa1:	89 54 24 04          	mov    %edx,0x4(%esp)
  801fa5:	8b 54 24 04          	mov    0x4(%esp),%edx
  ...
  801fcd:	d3 e6                	shl    %cl,%esi
  801fcf:	09 d8                	or     %ebx,%eax
  801fd1:	f7 74 24 08          	divl   0x8(%esp)
  ...
  801fe1:	39 d1                	cmp    %edx,%ecx
  801fe3:	72 06                	jb     801feb <__umoddi3+0x10b>
  801fe5:	75 10                	jne    801ff7 <__umoddi3+0x117>
  801fe7:	39 c3                	cmp    %eax,%ebx
  801fe9:	73 0c                	jae    801ff7 <__umoddi3+0x117>
  801feb:	2b 44 24 0c          	sub    0xc(%esp),%eax
  801fef:	1b 54 24 08          	sbb    0x8(%esp),%edx
  801ff3:	89 d7                	mov    %edx,%edi
  801ff5:	89 c6                	mov    %eax,%esi
  801ff7:	89 ca                	mov    %ecx,%edx
  801ff9:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  801ffe:	29 f3                	sub    %esi,%ebx
  802000:	19 fa                	sbb    %edi,%edx
  802002:	89 d0                	mov    %edx,%eax
  802004:	d3 e0                	shl    %cl,%eax
  802006:	89 e9                	mov    %ebp,%ecx
  802008:	d3 eb                	shr    %cl,%ebx
  ...
  802020:	29 fe                	sub    %edi,%esi
  802022:	19 c3                	sbb    %eax,%ebx
  802024:	89 f2                	mov    %esi,%edx
  802026:	89 d9                	mov    %ebx,%ecx
  802028:	e9 1d ff ff ff       	jmp    801f4a <__umoddi3+0x6a>
