...
umain(int argc, char **argv)
{
  ...
  800049:	52                   	push   %edx
  80004a:	50                   	push   %eax
  80004b:	68 20 1e 80 00       	push   $0x801e20
  ...
  80006e:	53                   	push   %ebx
  80006f:	50                   	push   %eax
  800070:	68 48 1e 80 00       	push   $0x801e48
  ...
  800090:	50                   	push   %eax
  800091:	68 7c 1e 80 00       	push   $0x801e7c
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800212:	e8 a9 19 00 00       	call   801bc0 <__udivdi3>
  ...
  800250:	e8 7b 1a 00 00       	call   801cd0 <__umoddi3>
  800255:	83 c4 14             	add    $0x14,%esp
  800258:	0f be 80 a5 1e 80 00 	movsbl 0x801ea5(%eax),%eax
  80025f:	50                   	push   %eax
...
0080030f <vprintfmt>:
{
  ...
  80035f:	3e ff 24 85 e0 1f 80 	notrack jmp *0x801fe0(,%eax,4)
  800366:	00 
  ...
  80042c:	8b 14 85 40 21 80 00 	mov    0x802140(,%eax,4),%edx
  800433:	85 d2                	test   %edx,%edx
  800435:	74 15                	je     80044c <vprintfmt+0x13d>
				printfmt(putch, putdat, "%s", p);
  800437:	52                   	push   %edx
  800438:	68 71 22 80 00       	push   $0x802271
  80043d:	56                   	push   %esi
  80043e:	53                   	push   %ebx
  ...
  80044c:	50                   	push   %eax
  80044d:	68 bd 1e 80 00       	push   $0x801ebd
  800452:	56                   	push   %esi
  800453:	53                   	push   %ebx
  ...
  80046e:	b8 b6 1e 80 00       	mov    $0x801eb6,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ace:	e8 51 0f 00 00       	call   801a24 <_panic>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dc5:	ba 48 22 80 00       	mov    $0x802248,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800de7:	51                   	push   %ecx
  800de8:	50                   	push   %eax
  800de9:	68 cc 21 80 00       	push   $0x8021cc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801055:	53                   	push   %ebx
  801056:	50                   	push   %eax
  801057:	68 0d 22 80 00       	push   $0x80220d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801126:	53                   	push   %ebx
  801127:	50                   	push   %eax
  801128:	68 29 22 80 00       	push   $0x802229
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011d6:	53                   	push   %ebx
  8011d7:	50                   	push   %eax
  8011d8:	68 ec 21 80 00       	push   $0x8021ec
...
stat(const char *path, struct Stat *stat)
{
  ...
  80127c:	e8 fb 01 00 00       	call   80147c <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  8012ce:	e8 09 08 00 00       	call   801adc <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  8012d3:	83 c4 0c             	add    $0xc,%esp
  8012d6:	6a 00                	push   $0x0
  8012d8:	53                   	push   %ebx
  8012d9:	6a 00                	push   $0x0
  8012db:	e8 8e 07 00 00       	call   801a6e <ipc_recv>
}
  ...
  8012ec:	e8 50 08 00 00       	call   801b41 <ipc_find_env>
...
008013ac <devfile_write>:
{
  ...
  8013db:	68 08 50 80 00       	push   $0x805008
  8013e0:	e8 e9 f4 ff ff       	call   8008ce <memmove>
	return fsipc(FSREQ_WRITE, NULL);
  8013e5:	ba 00 00 00 00       	mov    $0x0,%edx
  8013ea:	b8 04 00 00 00       	mov    $0x4,%eax
  8013ef:	e8 ba fe ff ff       	call   8012ae <fsipc>
}
  8013f4:	c9                   	leave  
  8013f5:	c3                   	ret    
...
008013f6 <devfile_read>:
{
  ...
  80141d:	e8 8c fe ff ff       	call   8012ae <fsipc>
  ...
  80143f:	e8 8a f4 ff ff       	call   8008ce <memmove>
	return r;
  ...
  80145c:	68 74 22 80 00       	push   $0x802274
  801461:	e8 be 05 00 00       	call   801a24 <_panic>
	assert(r <= PGSIZE);
  801466:	68 7f 22 80 00       	push   $0x80227f
  80146b:	68 5f 22 80 00       	push   $0x80225f
  801470:	6a 7d                	push   $0x7d
  801472:	68 74 22 80 00       	push   $0x802274
...
0080147c <open>:
{
  ...
  80148b:	56                   	push   %esi
  80148c:	e8 42 f2 ff ff       	call   8006d3 <strlen>
  ...
  8014a1:	50                   	push   %eax
  8014a2:	e8 67 f8 ff ff       	call   800d0e <fd_alloc>
  ...
  8014b9:	e8 58 f2 ff ff       	call   800716 <strcpy>
  ...
  8014ce:	e8 db fd ff ff       	call   8012ae <fsipc>
  ...
  8014e2:	e8 f4 f7 ff ff       	call   800cdb <fd2num>
  ...
  8014fd:	e8 10 f9 ff ff       	call   800e12 <fd_close>
		return r;
...
sync(void)
{
  ...
  801522:	e8 87 fd ff ff       	call   8012ae <fsipc>
}
  801527:	c9                   	leave  
  801528:	c3                   	ret    
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80153b:	e8 af f7 ff ff       	call   800cef <fd2data>
  801540:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  801542:	83 c4 08             	add    $0x8,%esp
  801545:	68 8b 22 80 00       	push   $0x80228b
  80154a:	53                   	push   %ebx
  80154b:	e8 c6 f1 ff ff       	call   800716 <strcpy>
...
devpipe_close(struct Fd *fd)
{
  ...
  80158c:	e8 5f f6 ff ff       	call   800bf0 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  801591:	89 1c 24             	mov    %ebx,(%esp)
  801594:	e8 56 f7 ff ff       	call   800cef <fd2data>
  801599:	83 c4 08             	add    $0x8,%esp
  80159c:	50                   	push   %eax
  80159d:	6a 00                	push   $0x0
  80159f:	e8 4c f6 ff ff       	call   800bf0 <sys_page_unmap>
}
...
008015a9 <_pipeisclosed>:
{
  ...
  8015c1:	57                   	push   %edi
  8015c2:	e8 b7 05 00 00       	call   801b7e <pageref>
  8015c7:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8015ca:	89 34 24             	mov    %esi,(%esp)
  8015cd:	e8 ac 05 00 00       	call   801b7e <pageref>
		nn = thisenv->env_runs;
  8015d2:	8b 15 04 40 80 00    	mov    0x804004,%edx
  ...
  8015ec:	50                   	push   %eax
  8015ed:	53                   	push   %ebx
  8015ee:	68 92 22 80 00       	push   $0x802292
  8015f3:	e8 b4 eb ff ff       	call   8001ac <cprintf>
...
0080160e <devpipe_write>:
{
  ...
  80161e:	56                   	push   %esi
  80161f:	e8 cb f6 ff ff       	call   800cef <fd2data>
  ...
  80164a:	75 3b                	jne    801687 <devpipe_write+0x79>
			sys_yield();
  80164c:	e8 22 f5 ff ff       	call   800b73 <sys_yield>
...
00801694 <devpipe_read>:
{
  ...
  8016a1:	8b 7d 08             	mov    0x8(%ebp),%edi
	p = (struct Pipe*)fd2data(fd);
  8016a4:	57                   	push   %edi
  8016a5:	e8 45 f6 ff ff       	call   800cef <fd2data>
  ...
  8016c7:	c3                   	ret    
			sys_yield();
  8016c8:	e8 a6 f4 ff ff       	call   800b73 <sys_yield>
...
0080170a <pipe>:
{
  ...
  801719:	50                   	push   %eax
  80171a:	e8 ef f5 ff ff       	call   800d0e <fd_alloc>
  ...
  801739:	e8 60 f4 ff ff       	call   800b9e <sys_page_alloc>
  ...
  801751:	50                   	push   %eax
  801752:	e8 b7 f5 ff ff       	call   800d0e <fd_alloc>
  ...
  801771:	e8 28 f4 ff ff       	call   800b9e <sys_page_alloc>
  ...
  801789:	e8 61 f5 ff ff       	call   800cef <fd2data>
  ...
  80179b:	e8 fe f3 ff ff       	call   800b9e <sys_page_alloc>
  ...
  8017b3:	e8 37 f5 ff ff       	call   800cef <fd2data>
  8017b8:	c7 04 24 07 04 00 00 	movl   $0x407,(%esp)
  8017bf:	50                   	push   %eax
  8017c0:	6a 00                	push   $0x0
  8017c2:	56                   	push   %esi
  8017c3:	6a 00                	push   $0x0
  8017c5:	e8 fc f3 ff ff       	call   800bc6 <sys_page_map>
...
00801858 <pipeisclosed>:
{
  ...
  801869:	e8 f6 f4 ff ff       	call   800d64 <fd_lookup>
  ...
  80187b:	e8 6f f4 ff ff       	call   800cef <fd2data>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8018a3:	68 aa 22 80 00       	push   $0x8022aa
  8018a8:	ff 75 0c             	pushl  0xc(%ebp)
  8018ab:	e8 66 ee ff ff       	call   800716 <strcpy>
	return 0;
}
...
008018b7 <devcons_write>:
{
  ...
  8018f0:	50                   	push   %eax
  8018f1:	57                   	push   %edi
  8018f2:	e8 d7 ef ff ff       	call   8008ce <memmove>
		sys_cputs(buf, m);
  8018f7:	83 c4 08             	add    $0x8,%esp
  8018fa:	53                   	push   %ebx
  8018fb:	57                   	push   %edi
  8018fc:	e8 d2 f1 ff ff       	call   800ad3 <sys_cputs>
	for (tot = 0; tot < n; tot += m) {
...
00801912 <devcons_read>:
{
  ...
  801925:	74 21                	je     801948 <devcons_read+0x36>
	while ((c = sys_cgetc()) == 0)
  801927:	e8 d1 f1 ff ff       	call   800afd <sys_cgetc>
  80192c:	85 c0                	test   %eax,%eax
  80192e:	75 07                	jne    801937 <devcons_read+0x25>
		sys_yield();
  801930:	e8 3e f2 ff ff       	call   800b73 <sys_yield>
...
00801951 <cputchar>:
{
  ...
  801966:	50                   	push   %eax
  801967:	e8 67 f1 ff ff       	call   800ad3 <sys_cputs>
}
...
00801971 <getchar>:
{
  ...
  801983:	e8 5f f6 ff ff       	call   800fe7 <read>
	if (r < 0)
...
0080199e <iscons>:
{
  ...
  8019af:	e8 b0 f3 ff ff       	call   800d64 <fd_lookup>
...
008019ce <opencons>:
{
  ...
  8019db:	50                   	push   %eax
  8019dc:	e8 2d f3 ff ff       	call   800d0e <fd_alloc>
  ...
  8019f5:	e8 a4 f1 ff ff       	call   800b9e <sys_page_alloc>
  ...
  801a19:	50                   	push   %eax
  801a1a:	e8 bc f2 ff ff       	call   800cdb <fd2num>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a36:	e8 10 f1 ff ff       	call   800b4b <sys_getenvid>
  801a3b:	83 ec 0c             	sub    $0xc,%esp
  801a3e:	ff 75 0c             	pushl  0xc(%ebp)
  801a41:	ff 75 08             	pushl  0x8(%ebp)
  801a44:	56                   	push   %esi
  801a45:	50                   	push   %eax
  801a46:	68 b8 22 80 00       	push   $0x8022b8
  801a4b:	e8 5c e7 ff ff       	call   8001ac <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801a50:	83 c4 18             	add    $0x18,%esp
  801a53:	53                   	push   %ebx
  801a54:	ff 75 10             	pushl  0x10(%ebp)
  801a57:	e8 fb e6 ff ff       	call   800157 <vcprintf>
	cprintf("\n");
  801a5c:	c7 04 24 a3 22 80 00 	movl   $0x8022a3,(%esp)
  801a63:	e8 44 e7 ff ff       	call   8001ac <cprintf>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801a8d:	50                   	push   %eax
  801a8e:	e8 22 f2 ff ff       	call   800cb5 <sys_ipc_recv>

	if (from_env_store != NULL)
  801a93:	83 c4 10             	add    $0x10,%esp
  801a96:	85 f6                	test   %esi,%esi
  801a98:	74 15                	je     801aaf <ipc_recv+0x41>
		*from_env_store = err ? 0 : thisenv->env_ipc_from;
  801a9a:	ba 00 00 00 00       	mov    $0x0,%edx
  801a9f:	83 f8 fd             	cmp    $0xfffffffd,%eax
  801aa2:	74 09                	je     801aad <ipc_recv+0x3f>
  801aa4:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801aaa:	8b 52 74             	mov    0x74(%edx),%edx
  801aad:	89 16                	mov    %edx,(%esi)

	if (perm_store != NULL)
  801aaf:	85 db                	test   %ebx,%ebx
  801ab1:	74 15                	je     801ac8 <ipc_recv+0x5a>
		*perm_store = err ? 0 : thisenv->env_ipc_perm;
  801ab3:	ba 00 00 00 00       	mov    $0x0,%edx
  801ab8:	83 f8 fd             	cmp    $0xfffffffd,%eax
  801abb:	74 09                	je     801ac6 <ipc_recv+0x58>
  801abd:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801ac3:	8b 52 78             	mov    0x78(%edx),%edx
  801ac6:	89 13                	mov    %edx,(%ebx)

	return err ? -E_INVAL : thisenv->env_ipc_value;
  801ac8:	83 f8 fd             	cmp    $0xfffffffd,%eax
  801acb:	74 08                	je     801ad5 <ipc_recv+0x67>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801af2:	eb 1f                	jmp    801b13 <ipc_send+0x37>
	int res;
	while (true) {
		if (pg != NULL) {
  ...
  801af6:	68 00 00 c0 ee       	push   $0xeec00000
  801afb:	56                   	push   %esi
  801afc:	57                   	push   %edi
  801afd:	e8 8a f1 ff ff       	call   800c8c <sys_ipc_try_send>
  801b02:	83 c4 10             	add    $0x10,%esp
		}

		if (res == 0)
  801b05:	85 c0                	test   %eax,%eax
  801b07:	74 30                	je     801b39 <ipc_send+0x5d>
			return;
		if (res != -E_IPC_NOT_RECV)
  801b09:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801b0c:	75 19                	jne    801b27 <ipc_send+0x4b>
			panic("ipc_send: %d", res);
		sys_yield();
  801b0e:	e8 60 f0 ff ff       	call   800b73 <sys_yield>
		if (pg != NULL) {
  801b13:	85 db                	test   %ebx,%ebx
  801b15:	74 dd                	je     801af4 <ipc_send+0x18>
			res = sys_ipc_try_send(to_env, val, pg, perm);
  801b17:	ff 75 14             	pushl  0x14(%ebp)
  801b1a:	53                   	push   %ebx
  801b1b:	56                   	push   %esi
  801b1c:	57                   	push   %edi
  801b1d:	e8 6a f1 ff ff       	call   800c8c <sys_ipc_try_send>
  801b22:	83 c4 10             	add    $0x10,%esp
  801b25:	eb de                	jmp    801b05 <ipc_send+0x29>
			panic("ipc_send: %d", res);
  801b27:	50                   	push   %eax
  801b28:	68 db 22 80 00       	push   $0x8022db
  801b2d:	6a 3e                	push   $0x3e
  801b2f:	68 e8 22 80 00       	push   $0x8022e8
  801b34:	e8 eb fe ff ff       	call   801a24 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801b5e:	74 11                	je     801b71 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801b60:	83 c0 01             	add    $0x1,%eax
  801b63:	3d 00 04 00 00       	cmp    $0x400,%eax
  801b68:	75 e6                	jne    801b50 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801b6a:	b8 00 00 00 00       	mov    $0x0,%eax
  801b6f:	eb 0b                	jmp    801b7c <ipc_find_env+0x3b>
			return envs[i].env_id;
  801b71:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801b74:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801b79:	8b 40 48             	mov    0x48(%eax),%eax
}
  801b7c:	5d                   	pop    %ebp
  801b7d:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801b8a:	c1 ea 16             	shr    $0x16,%edx
  801b8d:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801b94:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801b99:	f6 c1 01             	test   $0x1,%cl
  801b9c:	74 1c                	je     801bba <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801b9e:	c1 e8 0c             	shr    $0xc,%eax
  801ba1:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801ba8:	a8 01                	test   $0x1,%al
  801baa:	74 0e                	je     801bba <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801bac:	c1 e8 0c             	shr    $0xc,%eax
  801baf:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801bb6:	ef 
  801bb7:	0f b7 d2             	movzwl %dx,%edx
}
