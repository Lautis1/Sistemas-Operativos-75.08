	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800207:	0f be 80 08 1e 80 00 	movsbl 0x801e08(%eax),%eax
  80020e:	50                   	push   %eax
...
008002be <vprintfmt>:
{
  ...
  80030e:	3e ff 24 85 40 1f 80 	notrack jmp *0x801f40(,%eax,4)
  800315:	00 
  ...
  8003db:	8b 14 85 a0 20 80 00 	mov    0x8020a0(,%eax,4),%edx
  8003e2:	85 d2                	test   %edx,%edx
  8003e4:	74 15                	je     8003fb <vprintfmt+0x13d>
				printfmt(putch, putdat, "%s", p);
  8003e6:	52                   	push   %edx
  8003e7:	68 d1 21 80 00       	push   $0x8021d1
  8003ec:	56                   	push   %esi
  8003ed:	53                   	push   %ebx
  ...
  8003fb:	50                   	push   %eax
  8003fc:	68 20 1e 80 00       	push   $0x801e20
  800401:	56                   	push   %esi
  800402:	53                   	push   %ebx
  ...
  80041d:	b8 19 1e 80 00       	mov    $0x801e19,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a71:	68 ff 20 80 00       	push   $0x8020ff
  800a76:	6a 23                	push   $0x23
  800a78:	68 1c 21 80 00       	push   $0x80211c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800d74:	ba a8 21 80 00       	mov    $0x8021a8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800d96:	51                   	push   %ecx
  800d97:	50                   	push   %eax
  800d98:	68 2c 21 80 00       	push   $0x80212c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801004:	53                   	push   %ebx
  801005:	50                   	push   %eax
  801006:	68 6d 21 80 00       	push   $0x80216d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8010d5:	53                   	push   %ebx
  8010d6:	50                   	push   %eax
  8010d7:	68 89 21 80 00       	push   $0x802189
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801185:	53                   	push   %ebx
  801186:	50                   	push   %eax
  801187:	68 4c 21 80 00       	push   $0x80214c
...
008013a5 <devfile_read>:
{
  ...
  8013fe:	c3                   	ret    
	assert(r <= n);
  8013ff:	68 b8 21 80 00       	push   $0x8021b8
  801404:	68 bf 21 80 00       	push   $0x8021bf
  801409:	6a 7c                	push   $0x7c
  80140b:	68 d4 21 80 00       	push   $0x8021d4
  801410:	e8 be 05 00 00       	call   8019d3 <_panic>
	assert(r <= PGSIZE);
  801415:	68 df 21 80 00       	push   $0x8021df
  80141a:	68 bf 21 80 00       	push   $0x8021bf
  80141f:	6a 7d                	push   $0x7d
  801421:	68 d4 21 80 00       	push   $0x8021d4
...
00801558 <_pipeisclosed>:
{
  ...
  80159b:	50                   	push   %eax
  80159c:	53                   	push   %ebx
  80159d:	68 f2 21 80 00       	push   $0x8021f2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801852:	68 0a 22 80 00       	push   $0x80220a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019f3:	56                   	push   %esi
  8019f4:	50                   	push   %eax
  8019f5:	68 18 22 80 00       	push   $0x802218
  ...
  801a06:	e8 fb e6 ff ff       	call   800106 <vcprintf>
	cprintf("\n");
  801a0b:	c7 04 24 fc 1d 80 00 	movl   $0x801dfc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ad4:	eb de                	jmp    801ab4 <ipc_send+0x29>
			panic("ipc_send: %d", res);
  801ad6:	50                   	push   %eax
  801ad7:	68 3b 22 80 00       	push   $0x80223b
  801adc:	6a 3e                	push   $0x3e
  801ade:	68 48 22 80 00       	push   $0x802248
