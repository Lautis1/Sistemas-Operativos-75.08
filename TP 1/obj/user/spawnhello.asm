...
umain(int argc, char **argv)
{
  ...
  80006c:	c3                   	ret    
		panic("spawn(hello) failed: %e", r);
  80006d:	50                   	push   %eax
  80006e:	68 44 24 80 00       	push   $0x802444
  800073:	6a 09                	push   $0x9
  800075:	68 5c 24 80 00       	push   $0x80245c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80010b:	56                   	push   %esi
  80010c:	50                   	push   %eax
  80010d:	68 78 24 80 00       	push   $0x802478
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027e:	0f be 80 9b 24 80 00 	movsbl 0x80249b(%eax),%eax
  800285:	50                   	push   %eax
...
00800335 <vprintfmt>:
{
  ...
  800472:	50                   	push   %eax
  800473:	68 b3 24 80 00       	push   $0x8024b3
  800478:	56                   	push   %esi
  800479:	53                   	push   %ebx
  ...
  800494:	b8 ac 24 80 00       	mov    $0x8024ac,%eax
